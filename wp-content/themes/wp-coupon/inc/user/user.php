        ...
        if ( function_exists( 'WP_Users' ) ) {
            ...
            <ul class="st-menu">
                ...
                <li class="menu-item-has-children">
                    <a data-is-logged="<?php echo is_user_logged_in() ? 'true' : 'false'; ?>" class="wpu-login-btn" href="<?php echo WP_Users()->get_profile_link(); ?>"><i class="user icon"></i> <?php echo ( $is_logged_in ) ?  esc_html__( 'Dashboard', 'wp-coupon' ) :  esc_html__( 'Sign In', 'wp-coupon' ); ?></a>
                    <?php if ( $is_logged_in ) { ?>
                    <ul class="sub-menu">
