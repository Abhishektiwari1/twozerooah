...
class WPCoupon_Newsletter extends WP_Widget {
    ...
    function get_socials( $instance ){
        ...
        <?php if ( $instance['youtube'] ) { ?>
            <a target="<?php echo esc_attr( $instance['link_target'] ); ?>" href="<?php echo esc_attr( $instance['youtube'] ); ?>" class="ui circular icon button"><i class="youtube play icon"></i></a>
        <?php } ?>

        <?php if ( $instance['instagram'] ) { ?>
            <a target="<?php echo esc_attr( $instance['link_target'] ); ?>" href="<?php echo esc_attr( $instance['instagram'] ); ?>" class="ui circular icon button"><i class="instagram play icon"></i></a>
        <?php } ?>
        <?php if ( $instance['pinterest'] ) { ?>
            <a target="<?php echo esc_attr( $instance['link_target'] ); ?>" href="<?php echo esc_attr( $instance['pinterest'] ); ?>" class="ui circular icon button"><i class="pinterest play icon"></i></a>
        <?php } ?>
        <?php
