...
<section class="custom-page-header">
    <div class="container">
        ...
        */
        ...
        ?>
        <div class="inner shadow-box my_custom_use my_custom_use_a">
                ...
                if ($max_pages > $paged) { ?>
                    <div class="load-more wpb_content_element">
                        <a href="<?php next_posts($max_pages); ?>" class="ui button btn btn_primary btn_large" data-next-page="<?php echo($paged + 1); ?>"
                           ...
                           data-loading-text="<?php esc_attr_e('Loading...', 'wp-coupon'); ?>"><?php esc_html_e('Show More', 'wp-coupon'); ?> </a>
                    </div>
                <?php }
            } else {
