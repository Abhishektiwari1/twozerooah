...
<section class="custom-page-header single-store-header">
    <div class="container">
        ...
        ?>
        <div class="inner shadow-box my_custom_use dos my_custom_use_a">
...
<div id="content-wrap" class="container <?php echo esc_attr( $layout ); ?>">
    ...
    <div id="primary" class="content-area">
                        ...
                        if ( $coupon_max_pages > 1 ) { ?>
                            <div class="load-more wpb_content_element">
                                <a href="#" class="ui button btn btn_primary btn_large" data-doing="load_store_coupons" data-next-page="2"
                                   ...
                                   data-loading-text="<?php esc_attr_e('Loading...', 'wp-coupon'); ?>"><?php esc_html_e('Show More', 'wp-coupon'); ?> <i class="arrow circle outline down icon"></i></a>
                            </div>
                        <?php }
        ...
        <div>
<div class="flow_t_d store-1 sub-1">
<div class="clear_use"></div>
<div class="parent_div_use_half_one">
<div class="second_parent second_heading">
<div class="clear_use"></div>
<div class="half_same half-area">
<div>
<div class="name_tti name-sec name-area"><?php es_subbox($namefield = "YES", $desc = "", $group = "Public"); ?></div>
<div class="clear_use"></div>
<p><span class="margin_space_usesd"><a href="https://www.offersathome.com/privacy-policy/" target="_blank" rel="noopener">Privacy Policy</a></p></span>
</div>
</div>
 <div class="second-area">
        <h1>Never Miss an Offer Again</h1>
        <h2>Relax and sit back! OffersAtHome will send best of best offers into your inbox directly.</h2>
    </div>
</div>
</div>
</div>
